		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
					<div id="gtco-logo"><a >Online cab <em>.</em></a></div>
				</div>
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li class="has-dropdown">
							<a href="#">Data Entry</a>
							<ul class="dropdown">
                                                            <li><a href="Cast.jsp">Cast</a></li>
                                                            <li><a href="Religion.jsp">Religion</a></li>
                                                            <li><a href="District.jsp">District</a></li>
                                                            <li><a href="TaxiStand.jsp">Taxi Stand</a></li>
                                                            <li><a href="VechicleType.jsp">Vehicle Type</a></li>
							</ul>
						</li>
                                                <li><a href="DriverComplaints.jsp">Driver Complaints</a></li>
                                                <li><a href="UserFeedBack.jsp">User Feed Back</a></li>
                                                <li><a href="TaxiApproval.jsp">Taxi Approval</a></li>

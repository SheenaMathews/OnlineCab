...
<html>
   ...
   <h1>User Feed Back</h1>
        <table>
            ...
            <tr>
            <%
 ResultSet  rs1=obj.selectData("select * from tbl_taxifeedback tf,tbl_user us where tf.taxiId='"+TaxiId+"' and tf.userId=us.userId");
 while(rs1.next())
 {
            %>
            <td><label><%=rs1.getString("name")%></label>
                <br><label><%=rs1.getString("feedback")%></label></td>
            <%
 }
     %>
            </tr>
